...
<template>
    <Head title="ផ្ទេរចេញ | ស្នងការដ្ឋាននគរបាលខេត្តប៉ៃលិន" />
    <AuthenticatedLayout>
        <div class="py-2">
            <div class="flex justify-center mb-8 font-siemreap mx-5">
                <form @submit.prevent="handleSearch" class="w-full flex gap-2">
                    <div
                        class="w-full items-center flex justify-between gap-10"
                    >
                        <div class="w-1/2 bg-white py-4 px-2 rounded-lg">
                            <h1 class="font-siemreap text-lg font-bold">
                                បញ្ជីឈ្មោះមន្ត្រីផ្ទេរចេញ (ចេញទៅខេត្តឬអង្គភាពផ្សេង)
                            </h1>
                        </div>
