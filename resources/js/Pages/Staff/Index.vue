...
const goToDetail = (id) => {
    router.visit(route("staff.show", { id: id, origin: "staff.index" }));
};
...
<template>
    <Head title="តារាងឈ្មោះមន្រ្តី | ស្នងការដ្ឋាននគរបាលខេត្តប៉ៃលិន" />
    <AuthenticatedLayout>
                ...
                >
                    ...
                    <div class="w-full lg:w-auto flex justify-end">
                        <Link
                            ...
                            class="w-full lg:w-auto justify-center bg-[#01AAEB] hover:bg-[#079fdb] text-white py-3 lg:py-3.5 px-5 rounded-xl font-siemreap flex items-center shadow-md transition-all text-sm whitespace-nowrap"
                        >
                            <svg
